...
namespace EyeStereo {
	...
	public:
		...
		ID3D10EffectScalarVariable*         g_pBrightness_left; // 左眼 亮度
		ID3D10EffectScalarVariable*         g_pBrightness_right; // 右眼 亮度
		//	ID3D10EffectScalarVariable*         g_pContrast; // HLSL 对比度
